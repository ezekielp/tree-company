...
import { SlideoutCartProductThumbnail } from './SlideoutCartProductThumbnail';
...
export const SlideoutCartProductThumbnailContainer: FC<CartProductThumbnailContainerProps> = ({ productId, quantity, unitPrice }) => {
    ...
    return (
        <SlideoutCartProductThumbnail product={product} quantity={quantity} unitPrice={unitPrice} />
    );
};
